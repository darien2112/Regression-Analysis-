...
#Read in the data
gpa<-read.table(file = "C:\\Users\\pepu2\\OneDrive\\Máy tính\\Self-Studying\\STAT 450 (870) - Regression Analysis\\gpa.txt", header=TRUE, sep = "")
head(gpa)
...
#Example of how to designate automatically where to put legend     
#legend(x=2, y=2, legend = c("Sample model", "95% C.I.", "95% P.I."), col = c("red", "darkgreen", "blue"), 
lty = c("solid", "dashed", "dashed"), bty = "n", cex = 0.75)
